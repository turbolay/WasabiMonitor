...
public class WabiSabiMonitorRpc : IJsonRpcService
{
	...
	public static BetterHumanMonitorModel GetBetterHumanMonitor()
	{
		return BetterHumanMonitor.GetApiResponse();
	}
	
	[JsonRpcMethod("get-analysis")]
	public static Analyzer.Analysis? GetAnalysis(string? startTime = null, string? endTime = null)
	{
		...
		return Analyzer.Analyze(Analyzer.GetRoundsInInterval(startDateTime, endDateTime));
	}
    
	[JsonRpcMethod("get-rounds")]
	public static List<RoundState> GetRounds(string? startTime = null, string? endTime = null)
	{
		var (startDateTime, endDateTime) = ParseInterval(startTime, endTime);
